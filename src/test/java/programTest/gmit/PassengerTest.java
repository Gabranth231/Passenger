...
public class PassengerTest {
    ...
    public void TestConstructorTitle(){
        p1 = new Passenger("Mr","Martin","0000000000","1111111",22);
    ...
    public void TestConstructorInvalidTitle(){
        ...
        Exception exceptionThrown = assertThrows(IllegalArgumentException.class,()->
                new Passenger("Miss","Abby","0000000000","1111111",21));
        assertEquals(invalid,exceptionThrown.getMessage());
    }
    @Test
    public void TestConstructorName(){
        p1 = new Passenger("Mr","Tim","0000000000","1111111",22);
    ...
    public void TestConstructorInvalidName(){
        ...
        Exception exceptionThrown = assertThrows(IllegalArgumentException.class,()->
                new Passenger("Mr","Ti","0000000000","1111111",21));
        assertEquals(invalid,exceptionThrown.getMessage());
    }
    @Test
    ...
    public void TestConstructorInvalidID(){
        ...
        Exception exceptionThrown = assertThrows(IllegalArgumentException.class,()->
                new Passenger("Mr","Tim","000000000","1111111",21));
        assertEquals(invalid,exceptionThrown.getMessage());
    }
    @Test
    ...
    public void TestConstructorInvalidPhone(){
        final String invalid = "Invalid Phone Provided";
        Exception exceptionThrown = assertThrows(IllegalArgumentException.class,()->
                new Passenger("Mr","Tim","0000000000","111111",21));
        assertEquals(invalid,exceptionThrown.getMessage());
    }
    @Test
    ...
    public void TestConstructorInvalidAge(){
        final String invalid = "Invalid Age Provided";
        Exception exceptionThrown = assertThrows(IllegalArgumentException.class,()->
                new Passenger("Mr","Tim","0000000000","1111111",15));
        assertEquals(invalid,exceptionThrown.getMessage());
    }
}
